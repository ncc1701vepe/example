...
namespace km56.VirtualStorage.Api.Test
{
    ...
    public class AwsS3Test
    {
        ...
        public async Task CreateDownloadAndDeleteImageSuccessfully()
        {
            ...
            string connectionName = _configuration.GetSection("AwsConnectionName").Value;

            string filePath = _configuration.GetSection("AwsFilePath").Value;

            // Create File
            Image img = Image.FromFile(@"Samples\uml01.jpg");
            byte[] fileContent;
